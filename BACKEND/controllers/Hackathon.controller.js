...
const getHackathons = AsyncHandler(async (req, res) => {
  const hackathons =
    await HackathonService.getHackathons(req.query);
...
const deleteHackathon = AsyncHandler(async (req, res) => {
  await HackathonService.deleteHackathon(
    req.hackathon
  );
...
const openRegistration = AsyncHandler(async (req, res) => {
  const hackathon =
    await HackathonService.openRegistration(
      req.hackathon
    );
...
const closeRegistration = AsyncHandler(async (req, res) => {
  const hackathon =
    await HackathonService.closeRegistration(
      req.hackathon
    );
...
const publishResults = AsyncHandler(async (req, res) => {
  const hackathon =
    await HackathonService.publishResults(
      req.hackathon
    );
