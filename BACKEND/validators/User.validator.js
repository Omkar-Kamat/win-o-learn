 ...
 * Description: Implementation of User.validator.js
 */
...
export const validateUpdateProfile = [
    ...
    body('socials.github').optional().isURL().withMessage('Invalid GitHub URL'),
    body('socials.linkedin').optional().isURL().withMessage('Invalid LinkedIn URL'),
    body('socials.portfolio').optional().isURL().withMessage('Invalid Portfolio URL'),
...
export const validateRoleUpdate = [
    body('role')
        ...
        .isIn([ROLES.PARTICIPANT, ROLES.ORGANIZER, ROLES.JUDGE])
