...
export default function AssignedHackathons() {
 ...
 <div className="absolute inset-0 bg-bg/80 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center ] backdrop-blur-sm">
 <Link to={`/dashboard/judge/hackathons/${h._id}/submissions`} className="bg-primary text-on-primary px-6 py-3 ] font-medium hover:bg-primary-hover transition-colors">
 View Submissions
 </Link>
 </div>
 </div>
