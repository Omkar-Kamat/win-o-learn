...
export default function Profile() {
 ...
 <div className="w-20 h-20 bg-muted/50 border border-border overflow-hidden flex-shrink-0">
 {user?.avatar ? (
 ...
 className="text-sm text-muted-foreground file:mr-4 file:py-2 file:px-4 file: file:border-0 file:text-sm file:font-medium file:bg-primary/10 file:text-primary hover:file:bg-primary/10/80"
 />
 </div>
 </div>
 ...
 <textarea
 className={`h-24 py-3 px-4 ] bg-card border ${errors.bio ? 'border-error' : 'border-border'} text-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all resize-none`}
 {...register('bio')}
