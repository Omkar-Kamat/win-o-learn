...
export default function TeamsList() {
 ...
 <div className="bg-primary/10/30 border border-primary/20 p-6">
 <h2 className="text-2xl font-semibold tracking-tight font-semibold text-foreground mb-4">Pending Invitations</h2>
 <div className="space-y-3">
 {invitations.map(inv => (
 <div key={inv._id || inv.team?._id} className="flex justify-between items-center bg-card p-4 border border-border">
 <div>
