...
export default function ManageHackathon() {
 ...
 className="px-3 py-1 ] border border-border bg-muted/50 text-sm"
 value={judgeEmail}
 ...
 <li key={judgeAssignment._id} className="flex justify-between items-center p-3 bg-muted/50 ] border border-border">
 <div>
 ...
 <ul className="space-y-3">
 {submissions.map(sub => (
 <li key={sub._id} className="flex justify-between items-center p-3 bg-muted/50 ] border border-border">
 <div>
