      ...
      {isEdit && (
        <Card className="p-6">
          <div className="flex items-center gap-6">
            <div className="w-32 h-20 rounded-md bg-muted/50 border border-border overflow-hidden flex-shrink-0 flex items-center justify-center">
              {hackathon?.banner ? (
            ...
            <div>
              ...
              <input 
                ...
                className="text-sm text-muted-foreground file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-medium file:bg-primary/10 file:text-primary hover:file:bg-primary/10/80 cursor-pointer"
              />
