...
export default function ParticipantDashboard() {
 ...
 <div key={reg._id} className="flex justify-between items-center p-3 bg-muted/50 ] border border-border">
 <div>
 ...
 <div key={sub.id} className="flex justify-between items-center p-3 bg-muted/50 ] border border-border">
 <div>
