      ...
      <Card className="p-6">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex flex-col gap-1 w-full">
            ...
            <textarea
              className={`h-32 py-3 px-4 rounded-[10px] bg-card border ${errors.problemStatement ? 'border-error' : 'border-border'} text-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all resize-none`}
          ...
          <div className="flex flex-col gap-1 w-full">
            ...
            <textarea
              className={`h-48 py-3 px-4 rounded-[10px] bg-card border ${errors.solutionDescription ? 'border-error' : 'border-border'} text-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all resize-none`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full text-sm text-muted-foreground file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-medium file:bg-primary/10 file:text-primary hover:file:bg-primary/10/80 cursor-pointer"
                />
              </div>
              <div>
