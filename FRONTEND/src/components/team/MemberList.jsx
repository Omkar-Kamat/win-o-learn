export default function MemberList({ members, isLeader, onMakeLeader, onRemove }) {
 ...
 {members.map(member => (
 <li key={member._id} className="flex items-center justify-between p-4 bg-muted/50 ] border border-border">
 <div className="flex items-center gap-4">
 <div className="w-10 h-10 bg-primary/10 flex items-center justify-center text-primary-foreground font-bold">
