...
export default function Navbar({ onMenuClick }) {
 ...
 onClick={toggleTheme}
 className="p-2 hover:bg-muted/50 text-foreground transition-colors"
 >
 {theme === 'dark' ? (
 ...
 <Link to="/signup" className="px-4 py-2 bg-primary text-primary-foreground ] text-sm font-medium hover:bg-primary/90 transition-colors">Sign Up</Link>
 </div>
 )}
 </div>
 </nav>
